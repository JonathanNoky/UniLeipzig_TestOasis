![docker image](https://github.com/JonathanNoky/UniLeipzig_TestOasis/actions/workflows/docker-publish.yml/badge.svg)

# JonathanNoky's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of JonathanNoky.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/JonathanNoky/UniLeipzig_TestOasis.git
    cd UniLeipzig_TestOasis
    ```

    or

    ```sh
    curl -L -o UniLeipzig_TestOasis.zip "https://github.com/JonathanNoky/UniLeipzig_TestOasis/archive/main.zip"
    unzip UniLeipzig_TestOasis.zip
    cd UniLeipzig_TestOasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/jonathannoky/unileipzig_testoasis:main` for the services
...
```sh
docker pull ghcr.io/jonathannoky/unileipzig_testoasis/jupyter:main
```
...
- _I get an_ `Error response from daemon: Head "https://ghcr.io/v2/jonathannoky/unileipzig_testoasis/manifests/main": unauthorized` _when trying to pull my docker image._
